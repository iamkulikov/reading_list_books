...
9. **Разница-в-разницах** измеряет эффект воздействия для неоднородных по outcome групп, используя в качестве counterfactual динамику untreated. Соответственно, главное предположение - в отсутствие воздействия динамика outcome в экспериментальной группе была бы как у контрольной группы. Все это не обязательно происходит в одном времени, можно центрировать вокург воздействия. Тройная разница - для сравнения найденного эффекта и аналогичным образом измеренного эффекта для группы, в которой заведомо его быть не должно было (плацебо). 

10. **Метод синтетического контроля** - имба в смысле наглядности. Можно использовать и при наличии меняющегося во времени ненаблюдаемого confounder-а.
...
15. Разница-в-разницах-в-разницах (DDD) - проверка с помощью плацебо группы. 

16. Пример с эффектом от легализации абортов на снижение частоты гонореи через 15-20 лет. Удачно, что были штаты, которые ввели на 3 года позже - это создало очень специальную форму теоретической разницы между ними - разница в численности поколений, на которое повлияла политика.

17. Тот факт, что исследователь может произвольно влиять на отбор переменных для мэтчинга приводит к 13-14% вероятности принятия гипотезы о значимости treatment-а на 5%-ном уровне в случае реального отсутствия влияния. Ну это не очень много.

18. Мэтчинг в SCM идет по многим переменным, не только outcome.

19. Инвестиции в строительство тюрем привели к большей доле заключений в Техасе.
...
3. SCM для санкций еще раз попробовать, но помнить, что там вероятно есть петля обратной связи для стран не под санкциями, то есть на какие-то тоже treatment действует.
